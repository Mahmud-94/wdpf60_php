...
if(isset($_POST['insert']))
{
	...
	if(!empty($district) && !empty($city)){
		$sql="insert into city (cname,did) values('$city','$district')";
													...
													<div class="form-group row">
														...
														<div class="col-lg-9" >	
															<select class="form-control" name="district">
																...
																<?php
																		$query1=mysqli_query($con,"select * from district");
								...
								<div class="card-body">
									...
									<table id="basic-datatable" class="table table-bordered table-hover">
											...
											<?php
												...
												$query=mysqli_query($con,"select city.*,district.dname from city,district where city.did=district.did");
												$cnt=1;
