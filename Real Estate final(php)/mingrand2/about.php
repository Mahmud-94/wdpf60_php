            ...
            <div class="single-about-inner about-line-right bg-white">
                <div class="row no-gutter">
                    <div class="col-lg-4 order-lg-12">
                        <div class="thumb" style="background: url(assets/img/other/222.jpg);"></div>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-10">
                    <div class="single-service-wrap style-2 small-padding" style="background-image: url(assets/img/service/01.png);">
                        <div class="thumb">
                ...
                <div class="col-lg-4 col-md-10">
                    <div class="single-service-wrap style-2 small-padding" style="background-image: url(assets/img/service/02.png);">
                        <div class="thumb">
                ...
                <div class="col-lg-4 col-md-10">
                    <div class="single-service-wrap style-2 small-padding" style="background-image: url(assets/img/service/03.png);">
                        <div class="thumb">
