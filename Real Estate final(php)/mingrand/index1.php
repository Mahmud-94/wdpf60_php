...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-10">
                    <div class="section-title text-center">
                        ...
                        <p>consectetur
                            adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua eiusmod
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-category-product-wrap">
                        ...
                        <div class="single-category-product-details">
                            ...
                            <a class="btn btn-base" href="property.html">3 Porparties</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-category-product-wrap">
                        ...
                        <div class="single-category-product-details">
                            ...
                            <a class="btn btn-base" href="property.html">6 Porparties</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-category-product-wrap">
                        ...
                        <div class="single-category-product-details">
                            ...
                            <a class="btn btn-base" href="property.html">2 Porparties</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 order-lg-12">
                    <div class="single-category-product-wrap">
                        ...
                        <div class="single-category-product-details">
                            <h4><a href="property-details.html">Family House</a></h4>
                            <a class="btn btn-base" href="property.html">1 Porparties</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8 order-lg-1">
                    <div class="single-category-product-wrap">
                        ...
                        <div class="single-category-product-details">
                            ...
                            <a class="btn btn-base" href="property.html">7 Porparties</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="testimonial-area pd-top-118 pd-bottom-120 bg-overlay" style="background: url(assets/img/bg/22.jpg);">
                            ...
                            <div class="item">
                                <div class="single-testimonial-inner style-two text-center">
                                    <div class="thumb main-thumb">
                                        <img src="assets/img/testimonial/11.png" alt="img">
                                    </div>
                                    <div class="details">
        ...
        <div class="container">
            ...
            <div class="mgd-tab-inner text-center">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="rent1-tab" data-toggle="tab" href="#rent1" role="tab"
                            aria-controls="rent1" aria-selected="true">Rent</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="sell1-tab" data-toggle="tab" href="#sell1" role="tab"
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                <div class="thumb">
                                    <img src="assets/img/project/111.png" alt="img">
                                    <div class="product-wrap-details">
                                        <div class="media">
                                            <div class="author">
                                                <img src="assets/img/author/1.png" alt="img">
                                            ...
                                            <div class="media-body">
                                                <h6><a href="#">Owner Name</a></h6>
                                                <p><img src="assets/img/icon/location-alt.png" alt="img">New York real
                                                    estate </p>
                                            </div>
                                            <a class="fav-btn float-right" href="#"><i class="far fa-heart"></i></a>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                <div class="thumb">
                                    <img src="assets/img/project/222.png" alt="img">
                                    <div class="product-wrap-details">
                                        <div class="media">
                                            <div class="author">
                                                <img src="assets/img/author/2.png" alt="img">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                <div class="thumb">
                                    <img src="assets/img/project/333.png" alt="img">
                                    <div class="product-wrap-details">
                                        <div class="media">
                                            <div class="author">
                                                <img src="assets/img/author/3.png" alt="img">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                <div class="thumb">
                                    <img src="assets/img/project/44.png" alt="img">
                                    <div class="product-wrap-details">
                                        <div class="media">
                                            <div class="author">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                <div class="thumb">
                                    <img src="assets/img/project/55.png" alt="img">
                                    <div class="product-wrap-details">
                                        <div class="media">
                                            <div class="author">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                <div class="thumb">
                                    <img src="assets/img/project/66.png" alt="img">
                                    <div class="product-wrap-details">
                                        <div class="media">
                                            <div class="author">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-10">
                    ...
                    <div class="btn-wrap mt-4 pt-3">
                        <a class="btn btn-base mr-2" href="add-property.html">SUBMIT</a>
                        <a class="btn btn-base ml-2" href="property-details.html">BUY NOW</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- client area start -->
    <div class="client-area client-area-pd bg-overlay pd-top-118" style="background: url(assets/img/other/11.jpg);">
        <div class="container">
            <div class="row justify-content-center text-lg-left text-center">
                <div class="col-lg-9">
                    <div class="section-title style-white mb-0">
                        ...
                        <p>Lorem ipsum dolor amet, consecteLorem ipsum dolor sit amet, consectetur adipisicing sed do
                            eiusmod tempor incididunt dolore magna consecteLorem ipsum dolor sit amet, consectetur
                            adipisicing elit,</p>
                    </div>
                </div>
                <div class="col-lg-3 align-self-end text-lg-right mt-4 mt-lg-0">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single-product-wrap style-bottom-radius">
                        <div class="thumb">
                            <img src="assets/img/project/1010.jpg" alt="img">
                        </div>
                        <div class="product-details-inner">
                            <ul class="meta-inner">
                            ...
                            <p>House ipsum dolor consectetur adipisicing elit, sed do eius Lorem ipsum dolo ame conse.
                            </p>
                            <a class="btn btn-base read-more" href="#"><i class="la la-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-product-wrap style-bottom-radius">
                        <div class="thumb">
                            <img src="assets/img/project/1111.jpg" alt="img">
                        </div>
                        <div class="product-details-inner">
                            <ul class="meta-inner">
                                <li><i class="fa fa-user"></i>By Admin</li>
                            ...
                            <p>Daily ipsum dolor consectetur adipisicing elit, sed do eius Lorem ipsum dolo ame conse.
                            </p>
                            <a class="btn btn-base read-more" href="#"><i class="la la-arrow-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-product-wrap style-bottom-radius">
                        <div class="thumb">
                            <img src="assets/img/project/1212.png" alt="img">
                        </div>
                        <div class="product-details-inner">
                            <ul class="meta-inner">
                                <li><i class="fa fa-user"></i>By Admin</li>
                            ...
                            <h4><a href="blog-details.html">Hotel Resort</a></h4>
                            <p>Resort ipsum dolor consectetur adipisicing elit, sed do eius Lorem ipsum dolo ame conse.
                            </p>
                            <a class="btn btn-base read-more" href="#"><i class="la la-arrow-right"></i></a>
                        </div>
                    </div>
