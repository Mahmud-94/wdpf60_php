                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                ...
                                <div class="product-details-inner">
                                    <h4><a href="property-details.php">Gorgeous Villa</a></h4>
                                    <ul class="meta-inner">
                                        <li><img src="assets/img/icon/location2.png" alt="img">New York</li>
                                        <li><a href="#">For Sell</a></li>
                                    </ul>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                ...
                                <div class="product-details-inner">
                                    <h4><a href="property-details.php">Daily Property</a></h4>
                                    <ul class="meta-inner">
                                        <li><img src="assets/img/icon/location2.png" alt="img">New York</li>
                                        <li><a href="#">For Sell</a></li>
                                    </ul>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                ...
                                <div class="product-details-inner">
                                    <h4><a href="property-details.php">Farm House</a></h4>
                                    <ul class="meta-inner">
                                        <li><img src="assets/img/icon/location2.png" alt="img">New York</li>
                                        <li><a href="#">For Sell</a></li>
                                    </ul>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                ...
                                <div class="product-details-inner">
                                    <h4><a href="property-details.php">Beach Side House</a></h4>
                                    <ul class="meta-inner">
                                        <li><img src="assets/img/icon/location2.png" alt="img">New York</li>
                                        <li><a href="#">For Sell</a></li>
                                    </ul>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                ...
                                <div class="product-details-inner">
                                    <h4><a href="property-details.php">Gorgeous Hotel</a></h4>
                                    <ul class="meta-inner">
                                        <li><img src="assets/img/icon/location2.png" alt="img">New York</li>
                                        <li><a href="#">For Sell</a></li>
                                    </ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-product-wrap style-bottom-radius">
                        ...
                        <div class="product-details-inner">
                            ...
                            <h4><a href="blog-details.php">Hotel Resort</a></h4>
