                                ...
                                <div class="card-body">
                                    ...
                                    if (isset($_POST['button'])) {
                                        ...
                                        if (move_uploaded_file($photo_tname, $path.$photo_name)) {
                                            ...
                                            $db->query("INSERT INTO doctors (id,specilization,doctorName,address,image,docFees,contactno,email,details, password) VALUES (NULL, '$specilization','$docname','$address','$url','$fee','$phone','$email','$details','$pass')");
                                    ...
                                    <form class="" action="#" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>email</label>
                                            <div>
                                                <input data-parsley-type="text" name="email" type="text" class="form-control" required placeholder="Enter only numbers" />
                                            </div>
                                        </div>
                                        <div class="form-group">
