                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="ecommerce-seller.php" data-key="t-seller"><?php echo $language['Seller'] ?>
                                    <span class="badge rounded-pill bg-danger-subtle text-danger float-end">New</span>
                                </a></li>
                                <li><a href="ecommerce-sale-details.php" data-key="t-sale-details"><?php echo $language['Sale-Details'] ?>
                                    <span class="badge rounded-pill bg-danger-subtle text-danger float-end">New</span>
                                </a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="ui-utilities.php" data-key="t-utility"><?php echo $language['Utilities'] ?>
                                    <span class="badge rounded-pill bg-danger-subtle text-danger float-end">New</span>
                                </a></li>
                            </ul>
                        </li>
